...
import ReviewsForm from "../../components/reviews-form/reviews-form.jsx";
...
const getNearestOffersMarkup = (propsOffers, nearestOffers) => {
  if (propsOffers.length) {
...
const getMapMarkup = (nearestOffers, id, coordinates, city) => {
...
const OfferPage = (props) => {
  const {userStatus, offers, nearestOffers, onFavoriteButtonClick, downloadReviews, downloadNearestOffers} = props;
  const offer = offers.find((serverOffer) => serverOffer.id === Number(props.match.params.id));
  const filteredOffers = offers.filter((item) => {
    return nearestOffers.some((nearestOffer) => nearestOffer.id === item.id);
  });
    ...
    <div className="page">
      ...
      <main className="page__main page__main--property">
        <section className="property">
          ...
          {getMapMarkup(filteredOffers, id, coordinates, city)}
        </section>
        {getNearestOffersMarkup(offers, filteredOffers)}
      </main>
    </div>
  );
};
